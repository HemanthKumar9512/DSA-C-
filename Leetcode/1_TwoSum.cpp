...
vector<int> usingHashing(vector<int> arr, int target){    // Time Complexity: O(n)
...
int main(){
    ...
    vector<int> sol=usingHashing(nums, target);
    cout<<"Using Hashing Technique: "<<sol[0]<<","<<sol[1]<<endl;
    return 0;
}
